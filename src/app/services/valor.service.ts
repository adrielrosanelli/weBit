  ...
  servicos: Array<Servico> = [
    {
      ...
      conteudo: `A instalação de redes de computadores oferece benefícios como compartilhamento de recursos, comunicação eficiente, acesso à internet, segurança de dados e colaboração entre equipes`
    },
    {
      lado: 'right',
      ...
      conteudo: `O cable management melhora a circulação do ar e reduz o acúmulo de poeira, proporcionando uma organização eficiente e prevenindo danos aos cabos e equipamentos.`
    },
    {
      lado: 'left',
...
//      conteudo: `A varredura de rede é o processo de escaneamento de uma rede para identificar e coletar informações sobre os dispositivos conectados.
    ...
    },
    {
      ...
      conteudo:'A varredura de redes identifica dispositivos e vulnerabilidades, permitindo a manutenção e proteção eficazes do ambiente de rede.'
    },
    {
      lado: 'left',
      ...
      conteudo:'A consultoria de redes de computadores pode otimizar infraestruturas, melhorar a eficiência operacional, identificar oportunidades de crescimento e fortalecer a segurança.'
    },
    {
      lado: 'right',
    ...
    conteudo:'A troca de equipamentos de redes de computadores pode melhorar a velocidade, segurança e confiabilidade da rede, impulsionando a produtividade e o desempenho geral do sistema.'},
  ];
